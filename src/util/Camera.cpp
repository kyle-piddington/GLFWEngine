...
Camera::Camera(float width, float height):
   ...
   currentPerspectiveMtx(glm::perspective(fov,aspectRatio,0.1f,150.0f)),
   currentOrthographicsMtx(glm::ortho(-2.f,2.0f,-2.f/aspectRatio,2.0f/aspectRatio,0.1f,150.f))
{
